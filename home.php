...
<body>
    ...
    <div class="center-container">
        <button class="button" onclick="window.location.href='game2.php';">Get Started</button>
    </div>

    <div class="content">
        <p>Embark on an interstellar adventure with AstroXteller, the ultimate space exploration game! Test your cosmic knowledge with thrilling space-related questions, unlock digital badges & trophies...</p>
    </div>
